...
@Autonomous
public class RedStart2ParkB extends LinearOpMode {
    public void runOpMode() {

        CompetitionRobot robot = new CompetitionRobot(this);

        BezierCurveRoute RedStart2ParkB = new BezierCurveRoute(
                new double[] {119.101666666667}, //The x-coefficients
                new double[] {1.19500000000002}, //The y-coefficients
                robot,
                0.4,
        ...
        sleep(500);
        RedStart2ParkB.executeWithPointSkip();
